...
def decimal_to_fraction(exposure_time):
  ...
  common_exposures = [
      1 / 16000, 1 / 14000, 1 / 12000, 1 / 10000, 1 / 8000, 1 / 6000, 1 / 4000,
      1 / 3200, 1 / 2500, 1 / 2000, 1 / 1600, 1 / 1250, 1 / 1000, 1 / 800,
      1 / 640, 1 / 500, 1 / 400, 1 / 320, 1 / 250, 1 / 200, 1 / 160, 1 / 125,
      1 / 100, 1 / 80, 1 / 60, 1 / 50, 1 / 40, 1 / 30, 1 / 25, 1 / 20, 1 / 15,
      1 / 13, 1 / 10, 1 / 8, 1 / 6, 1 / 5, 1 / 4, 1 / 3, 1 / 2.5, 1 / 2,
      1 / 1.5, 1
  ]
...
def apply_exposure_conversion(metadata):
  if 'EXIF:ExposureTime' in metadata:
    metadata['EXIF:ExposureTime'] = decimal_to_fraction(
...
def extract_exif_data_list(filepath):
  ...
  if metadata:
    filtered_metadata = {
        key: metadata[0][key]
        for key in desired_tags if key in metadata[0]
    }
